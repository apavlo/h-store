...
for skew in 0.8 1.01 1.1 1.2; do
    for round in 1 2 3; do
        OUTPUT_PREFIX="$OUTPUT_DIR/ycsb-T500-NoLoop-blocking/$round-ycsb1G-nonblocking-nvm-T500-S$skew"
        LOG_PREFIX="logs/test/ycsb-T500-NoLoop-blocking/$round-ycsb1G-nonblocking-nvm-T500-S$skew"
        echo $OUTPUT_PREFIX
        ...
        "-Dsite.anticache_enable=${ENABLE_ANTICACHE}" \
            ...
            "-Dclient.anticache_db_blocks=false" \
            "-Dclient.anticache_dbtype=NVM" \
