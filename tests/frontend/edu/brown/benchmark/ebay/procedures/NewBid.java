...
VALUES ($bidId, $itemId, $sellerId, $buyerId,  $qty, 0, $bid, $maxBid, '$now');
    ...
    public final SQLStmt getItemMaxBid = new SQLStmt(
        "SELECT " + EbayConstants.TABLENAME_ITEM_BID + ".* " + 
    ...
    */
    ...
    public final SQLStmt updateItemMaxBid = new SQLStmt(
        "UPDATE " + EbayConstants.TABLENAME_ITEM_MAX_BID + 
        "   SET imb_ib_id = ?, " +
        "       imb_ib_i_id = ?, " +
        "       imb_ib_u_id = ?, " +
        "       imb_updated = ? " +
    ...
    public final SQLStmt updateBid = new SQLStmt(
            "UPDATE " + EbayConstants.TABLENAME_ITEM_BID + 
            "   SET ib_bid = ? " +
            " WHERE ib_id = ? " +
            "   AND ib_i_id = ? " +
            "   AND ib_u_id = ? "
    ...
    public final SQLStmt insertItemBid = new SQLStmt(
        "INSERT INTO " + EbayConstants.TABLENAME_ITEM_BID + "(" +
        "ib_id, " +
        "ib_i_id, " +
        "ib_u_id, " + 
        "ib_buyer_id, " +
    ...
    public final SQLStmt insertItemMaxBid = new SQLStmt(
    	"INSERT INTO " + EbayConstants.TABLENAME_ITEM_MAX_BID + "(" +
    	"imb_i_id, " +
    	"imb_u_id, " +
    	"imb_ib_id, " +
    	"imb_ib_i_id, " +
