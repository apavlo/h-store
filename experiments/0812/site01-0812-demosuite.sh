...
--txnthreshold 0.95 -e "experiments/0812/site01-0812-demosuite-3runs.txt" --winconfig "tuple w100s10 (site01) perc_compare" \
...
#--txnthreshold 0.90 -e "experiments/0812/site01-0812-demosuite-3runs.txt" --winconfig "tuple w100s10 (site01) perc_compare" \
#--threads 1 --rmin 1000 --rstep 1000 --finalrstep 100 --warmup 10000 --numruns 3 --perc_compare
