...
python ./tools/runexperiments.py --tmin 1 --tmax 1 --tstep 1 --rmin 1000 --rmax 15000 --rstep 1000 --stop --warmup 10000 -p voterwinsstore -o "experiments/0505/site08/voterwinsstore-1c-10w10s-0505.txt"
...
python ./tools/runexperiments.py --tmin 1 --tmax 1 --tstep 1 --rmin 1000 --rmax 15000 --rstep 1000 --stop --warmup 40000 -p voterwintimesstorewinonly -o "experiments/0505/site08/voterwintimesstorewinonly-1c-10w2s1000t-0505.txt"
...
python ./tools/runexperiments.py --tmin 10 --tmax 10 --tstep 1 --rmin 100 --rmax 1500 --rstep 100 --stop --warmup 40000 -p voterdemosstorepetrigonly -o "experiments/0505/site08/voterdemosstorepetrigonly-10c-10w2s1000t-0505.txt"
