...
--threads 1 --rmin 1000 --rstep 1000 --finalrstep 100 --warmup 10000 --hstore --hscheduler --numruns 3
python ./tools/autorunexp.py -p "voterdemosstorewXsYY" -o "experiments/0806/voterdemosstorewXsYY-1c-90-0806-site10.txt" \
--txnthreshold 0.90 -e "experiments/0806/site10-0806-demosuite.txt" --winconfig "tuple w100s10 (site10)" \
--threads 1 --rmin 1000 --rstep 1000 --finalrstep 100 --warmup 10000 --hscheduler --numruns 3
python ./tools/autorunexp.py -p "voterdemosstorewXsYY" -o "experiments/0806/voterdemosstorewXsYY-1c-90-0806-site10.txt" \
--txnthreshold 0.90 -e "experiments/0806/site10-0806-demosuite.txt" --winconfig "tuple w100s10 (site10)" \
--threads 1 --rmin 1000 --rstep 1000 --finalrstep 100 --warmup 10000 --numruns 3

python ./tools/autorunexp.py -p "voterdemohstorewXsYY" -o "experiments/0806/voterdemohstorewXsYY-1c-90-0806-site10.txt" \
--txnthreshold 0.90 -e "experiments/0806/site10-0806-demosuite.txt" --winconfig "tuple w100s10 (site10)" \
--threads 1 --rmin 1000 --rstep 1000 --finalrstep 100 --finalrmin 300 --warmup 10000 --hstore --hscheduler --numruns 3
python ./tools/autorunexp.py -p "voterdemosstorewXsYY" -o "experiments/0806/voterdemosstorewXsYY-1c-90-0806-site10.txt" \
--txnthreshold 0.90 -e "experiments/0806/site10-0806-demosuite.txt" --winconfig "tuple w100s10 (site10)" \
--threads 1 --rmin 1000 --rstep 1000 --finalrstep 100 --finalrmin 300 --warmup 10000 --hscheduler --numruns 3
python ./tools/autorunexp.py -p "voterdemosstorewXsYY" -o "experiments/0806/voterdemosstorewXsYY-1c-90-0806-site10.txt" \
--txnthreshold 0.90 -e "experiments/0806/site10-0806-demosuite.txt" --winconfig "tuple w100s10 (site10)" \
--threads 1 --rmin 1000 --rstep 1000 --finalrstep 100 --finalrmin 300 --warmup 10000 --numruns 3
