...
string CLogFormatTab::GetLogOutput(CTradeLookupSettings& parms)
{
    ...
    logmsg << left << setw(40) << "BackOffFromEndTimeFrame2:" << parms.dft.BackOffFromEndTimeFrame2 << "\t" << parms.cur.BackOffFromEndTimeFrame2 << "\t" << (parms.state.BackOffFromEndTimeFrame2 ? "YES" : "NO") << endl;
    logmsg << left << setw(40) << "BackOffFromEndTimeFrame3:" << parms.dft.BackOffFromEndTimeFrame3 << "\t" << parms.cur.BackOffFromEndTimeFrame3 << "\t" << (parms.state.BackOffFromEndTimeFrame3 ? "YES" : "NO") << endl;
    logmsg << left << setw(40) << "BackOffFromEndTimeFrame4:" << parms.dft.BackOffFromEndTimeFrame4 << "\t" << parms.cur.BackOffFromEndTimeFrame4 << "\t" << (parms.state.BackOffFromEndTimeFrame4 ? "YES" : "NO") << endl;
...
string CLogFormatTab::GetLogOutput(CDriverCEPartitionSettings& parms)
{
    ...
    logmsg << left << setw(40) << "Partition Customer Count:" << parms.dft.iMyCustomerCount << "\t" << parms.cur.iMyCustomerCount << endl;
    logmsg << left << setw(40) << "Partition Percent:" << parms.dft.iPartitionPercent << "\t" << parms.cur.iPartitionPercent << "\t" << (parms.state.iPartitionPercent ? "YES" : "NO") << endl;
