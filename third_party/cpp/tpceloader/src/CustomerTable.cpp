...
char        EMAIL_DOMAINs[iNumEMAIL_DOMAINs][15] = {"@msn.com","@hotmail.com","@rr.com","@netzero.com","@earthlink.com","@attbi.com"};
}   // namespace TPCE
...
{
    m_rnd.RndAlphaNumFormatted(m_row.C_LOCAL_1, "nnnnnnn"); //7-digit phone number
}
...
{
    m_rnd.RndAlphaNumFormatted(m_row.C_LOCAL_2, "nnnnnnn"); //7-digit phone number
}
...
{
    m_rnd.RndAlphaNumFormatted(m_row.C_LOCAL_3, "nnnnnnn"); //7-digit phone number
}
...
void CCustomerTable::GenerateC_EXT_1()
{
    ...
    if (iThreshold <= 25)
    {
        m_rnd.RndAlphaNumFormatted(m_row.C_EXT_1, "nnn");   //3-digit phone extension
    }
    else
    {
...
void CCustomerTable::GenerateC_EXT_2()
{
    ...
    if (iThreshold <= 15)
    {
        m_rnd.RndAlphaNumFormatted(m_row.C_EXT_2, "nnn");   //3-digit phone extension
    }
    else
    {
...
void CCustomerTable::GenerateC_EXT_3()
{
    ...
    if (iThreshold <= 5)
    {
        m_rnd.RndAlphaNumFormatted(m_row.C_EXT_3, "nnn");   //3-digit phone extension
    }
    else
    {
