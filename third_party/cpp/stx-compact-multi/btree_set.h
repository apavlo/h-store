...
#ifndef STX_STX_BTREE_SET_H_HEADER
#define STX_STX_BTREE_SET_H_HEADER
...
public:
    ...
    typedef btree_set<key_type, key_compare, traits, allocator_type> self_type;
...
#endif // !STX_STX_BTREE_SET_H_HEADER
