...
#ifndef STX_STX_HYBRID_COMPACT_BTREE_MAP_H_HEADER
#define STX_STX_HYBRID_COMPACT_BTREE_MAP_H_HEADER
...
public:
    ...
    typedef stx_hybrid_compact::btree<key_type, data_type, value_type, key_compare,
...
public:
    ...
    {
        return tree.exists_static(key);
    }

    bool exists_hybrid(const key_type& key) const
    {
        return tree.exists_hybrid(key);
    }
    ...
    {
        return tree.lower_bound_static(key);
    }
...
public:
    ...
    int height_static() {
      return tree.height_static();
    }
};

} // namespace stx_hybrid_compact

#endif // !STX_STX_HYBRID_COMPACT_BTREE_MAP_H_HEADER
