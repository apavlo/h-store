...
public class MockExecutionEngine extends ExecutionEngine {
    ...
    @Override
    public void antiCacheInitialize(File dbFilePath, AntiCacheDBType dbType, boolean blocking, long blockSize, long maxSize) throws EEException {
        // TODO Auto-generated method stub
    }
    
    @Override
    public void antiCacheAddDB(File dbFilePath, AntiCacheDBType dbType, boolean blocking, long blockSize, long maxSize) throws EEException {
    }
