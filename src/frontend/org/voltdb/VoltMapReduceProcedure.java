    ...
    public final VoltTable run(Object params[]) {
        ...
        if (mr_ts.isMapPhase()) {
            ...
            if (is_local) {
                ...
                this.executor.getHStoreSite().getHStoreCoordinator().transactionMap(mr_ts, mr_ts.getTransactionMapCallback());
            }
            ...
            if (is_local) {
                ...
                this.executor.getHStoreSite().getHStoreCoordinator().transactionReduce(mr_ts, mr_ts.getTransactionReduceCallback());
            }
