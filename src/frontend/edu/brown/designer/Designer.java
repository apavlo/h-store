...
public class Designer {
    ...
    public Designer(DesignerInfo info, DesignerHints hints, ArgumentsParser args) throws Exception {
        ...
        if (this.args.pplan != null) this.pplan = this.args.pplan;
        ...
        if (this.args.pmap != null) this.pmap = this.args.pmap;
        ...
        if (this.args.iplan != null) this.iplan = this.args.iplan;
    ...
    private void init() throws Exception {
        ...
        for (Procedure catalog_proc : info.catalog_db.getProcedures()) {
            ...
            if ((!this.hints.proc_include.isEmpty() && !this.hints.proc_include.contains(catalog_proc.getName())) ||
                 this.hints.proc_exclude.contains(catalog_proc.getName())) {
            ...
            if (agraph.getVertexCount() == 0) {
                if (LOG.isDebugEnabled()) LOG.warn("The workload analyzer created an AccessGraph for " + catalog_proc + " with no vertices. Skipping...");
                continue;
            }
...
//    }
    ...
    public void apply() throws Exception {
        ...
        for (Table catalog_tbl : catalog_db.getTables()) {
            ...
            fields.put("isreplicated", catalog_tbl.getIsreplicated());
            fields.put("partitioncolumn", catalog_tbl.getPartitioncolumn());
...
//                total++;
//                SingleSitedCostModel.CostEstimate estimate = cmodel.isSingleSited(design.catalog_db, xact, null); 
...
//        System.out.println("SINGLE-SITED: " + singlesited + "/" + total);
        ...
        //VoltCompiler compiler = new VoltCompiler(null, BackendTarget.HSQLDB_BACKEND, 1, 1, "localhost", System.out);
