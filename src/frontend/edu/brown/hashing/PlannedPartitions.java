    ...
    public static class PartitionedTable<T extends Comparable<T>> {
        ...
        public PartitionedTable(VoltType vt, String table_name, JSONObject table_json) throws Exception{
            ...
            while(partitions.hasNext()){
                ...
                //TODO do we need more than ints, what about specifying ranges as replicated (ae)
        ...
        public int findPartition(T key_value) throws Exception {
            ...
            for (PartitionRange<T> p : partitions) {
                ...
                if ((p.min_inclusive.compareTo(key_value) <= 0 && p.max_exclusive.compareTo(key_value) > 0) || (p.min_inclusive.compareTo(key_value) == 0 && p.max_exclusive.compareTo(key_value) == 0)) {
                    return p.partition;
                }
            }
