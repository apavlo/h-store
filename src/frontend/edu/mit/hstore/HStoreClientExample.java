...
public class HStoreClientExample {
    public static void main(String[] vargs) throws Exception {
        ...
        args.require(ArgumentsParser.PARAM_SIMULATOR_HOST);
        
        // connect to VoltDB server
        Client client = ClientFactory.createClient();
        client.createConnection(null, args.getParam(ArgumentsParser.PARAM_SIMULATOR_HOST), Client.VOLTDB_SERVER_PORT, "user", "password");
