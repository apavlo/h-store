...
public class UpdateVotesAndTotalVotesTrigger extends VoltTrigger {
    ...
    public final SQLStmt insertVoteStmt = new SQLStmt(
        "INSERT INTO votes (vote_id, phone_number, state, contestant_number, time) SELECT * FROM S3;"
    );
    
    public final SQLStmt insertIntoWin = new SQLStmt(
        "INSERT INTO W_ROWS (vote_id, phone_number, state, contestant_number, time) SELECT * FROM S3;"
    );
}
