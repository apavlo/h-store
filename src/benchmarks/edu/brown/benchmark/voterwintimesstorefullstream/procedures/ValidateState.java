...
public class ValidateState extends VoltTrigger {
    ...
    public final SQLStmt insertS2pt2Stmt = 
           new SQLStmt("INSERT INTO S2 (vote_id, phone_number, state, contestant_number, time) SELECT S1.vote_id, S1.phone_number, s1.state, S1.contestant_number, S1.time FROM S1, area_code_state WHERE s1.area_code=area_code_state.area_code;");
