...
public class ValidateState extends VoltTrigger {
    ...
    public final SQLStmt insertS2Stmt = 
        //new SQLStmt("INSERT INTO S1 (vote_id, phone_number, state, contestant_number, time) SELECT S1.vote_id, S1.phone_number, area_code_state.state, S1.contestant_number, S1.time FROM S1, area_code_state WHERE s1.area_code=area_code_state.area_code AND s1.state='XX';");
    	new SQLStmt("UPDATE S1, area_code_state SET S1.state = area_code_state.state WHERE s1.area_code=area_code_state.area_code;");
