...
public class VoterStreamWindowsClient extends BenchmarkComponent {
    private static final Logger LOG = Logger.getLogger(VoterStreamWindowsClient.class);
    ...
    public static void main(String args[]) {
        BenchmarkComponent.main(VoterStreamWindowsClient.class, args, false);
    }

    public VoterStreamWindowsClient(String args[]) {
        super(args);
