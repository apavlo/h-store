...
public class AnotherVoterStreamClient extends BenchmarkComponent {
    private static final Logger LOG = Logger.getLogger(AnotherVoterStreamClient.class);
    ...
    public static void main(String args[]) {
        BenchmarkComponent.main(AnotherVoterStreamClient.class, args, false);
    }

    public AnotherVoterStreamClient(String args[]) {
        super(args);
