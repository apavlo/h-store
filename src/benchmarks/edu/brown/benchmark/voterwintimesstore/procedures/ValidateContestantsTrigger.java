...
public class ValidateContestantsTrigger extends VoltTrigger {
    ...
    public final SQLStmt insertS1Stmt = 
        new SQLStmt("INSERT INTO S1 (vote_id, phone_number, state, contestant_number, time) SELECT votes_stream.* FROM votes_stream, contestants WHERE votes_stream.contestant_number=contestants.contestant_number;");
