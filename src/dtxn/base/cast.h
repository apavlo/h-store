...
#ifndef BASE_CAST_H__
#define BASE_CAST_H__
...
// Cast from unsigned to signed types has a special form: don't check the lower bound
template <typename DestinationType, typename SourceType>
...
template <typename DestinationType, typename SourceType, bool destination_signed, bool source_signed>
